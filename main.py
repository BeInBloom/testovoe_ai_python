...
@cli_app.command()
def main(
    folder: Optional[Path] = typer.Argument(None, dir_okay=True, help="Папка с документами"),
    ...
    try:
        ...
        # Выполнение сценария
        if list_prompts: return app.list_prompts()
        if list_skills: return app.list_skills()
